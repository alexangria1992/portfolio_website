...
const projects = [
  ...
  },
  {
    ...
    live: 'https://portfolio-website-bgkkiezuw-alexangria1992s-projects.vercel.app/',
          ...
          <div className='w-full xl:w-[50%]'>
            ...
            >
              ...
              <WorkSliderBtns
                ...
                btnStyles='bg-accent hove:bg-accent-hover text-primary text-[22px] w-[44px] h-[44px] flex justify-center items-center transition-all'
              />
            </Swiper>
          </div>
        </div>
